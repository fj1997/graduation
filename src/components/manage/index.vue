    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          <span class="el-dropdown-link userinfo-inner"><i class="iconfont icon-user"></i> fujie  <i
    ...
    <el-col :span="24" class="main">
      ...
      <aside :class="{showSidebar:!collapsed}">
        ...
        <el-menu :default-active="defaultActiveIndex" router :collapse="collapsed" @select="handleSelect">
          <template v-for="route in $router.options.routes" v-if="route.name=='Manage'">
            ...
            <!-- <el-menu-item v-if="item.children&&item.children.length" :index="item.children[0].path"
